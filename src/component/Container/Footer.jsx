...
const Footer = () => {
  return (
    ...
    >
      <div
        className="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1
      place-items-start  gap-8 text-white"
      >
        <div>
          <div className="font-bold mb-6">Get Started</div>
          <p className="text-sm leading-7 pr-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio
            nam maiores autem placeat. Necessitatibus, libero!
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-sm mb-4">tejaslearning@gmail.com</div>
          <div className="text-sm">+912585654232</div>
